            ...
            <ModalTemplate headerContent={
                ...
                <>
                    <div className="inputPkmn">
                        ...
                        <h4>On peut utiliser css grid pour changer l'affichage de notre liste</h4>
                        <label>Changer le nombre de colonnes : </label>
                        <input type='number' value={colonm} onChange={event => handleSetColomn(event.target.value)} min={1} max={5} placeholder='Nombre de colonnes'></input>
                    </div>
                ...
                fetchList === 'digimon' ?
                    <>
                        <div className="inputPkmn">
                            ...
                            <h4>On peut utiliser css grid pour changer l'affichage de notre liste</h4>
                            <label>Changer le nombre de colonnes : </label>
                            <input type='number' value={colonm > 3 ? setColomn(3) : colonm} onChange={event => handleSetColomn(event.target.value)} min={1} max={3} placeholder='Nombre de colonnes'></input>
                        </div>
