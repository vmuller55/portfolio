          ...
          <>
            <div className="selectorInput">
              <>
                ...
                <input type="range" min={'0'} max={'357'} value={styleOptions.backgroundColor} onChange={event => handleOptionChange('backgroundColor', event.target.value)} className="selector"/>
              </>
              <>
                <label>Couleur du texte : </label>
                <input type="range" min={'0'} max={'357'} value={styleOptions.textColor} onChange={event => handleOptionChange('textColor', event.target.value)} className="selector"/>
              </>
              </div>
              <label>Angles des bordures : </label>
                <input type="range" min="0" max="50" value={styleOptions.borderRadius} onChange={event => handleOptionChange('borderRadius', event.target.value)}/>
            ...
            <div className="input-section">
              <div className="selectorInput">
                <div className="splitGrid">
                  ...
                  <input type="range" min="10" max="50" value={styleOptions.fontSize} onChange={event => handleOptionChange('fontSize', event.target.value)} className='range'/>
                </div>
                <div className="splitGrid">
                  <label>Couleur du fond : </label>
